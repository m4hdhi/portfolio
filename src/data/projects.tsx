...
type ProjectSkillKey = keyof typeof PROJECT_SKILLS;

const getProjectSkills = (skillKeys: string[]) =>
  skillKeys
    .map((key) => PROJECT_SKILLS[key as ProjectSkillKey])
    .filter(Boolean);
...
const PROJECT_DETAILS: Project[] = [
  {
    ...
    github: "https://github.com/m4hdhi/Coding-Ducks",
    get content() {
      return (
        <div>
  ...
  },
  {
    ...
    screenshots: ["1.png"],
    live: "https://m4hdhi.github.io",
    github:"https://github.com/m4hdhi/mahdhi-portfolio",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.next,
  ...
  },
  {
    ...
    github:"https://github.com/m4hdhi/GhostChat",
    skills: {
  ...
  },
  {
    ...
    screenshots: ["1.png"],
    live: "https://m4hdhi.github.io/JNTUA-result-analyser-spa/#/",
    skills: {
...
const genericProjectContent = (project: PortfolioProject) => (
  <div>
    <TypographyP className="font-mono">
      This project is managed from the portfolio dashboard. Add richer notes,
      screenshots, and case-study details in the code when you want a fully
      custom project story.
    </TypographyP>
    <ProjectsLinks live={project.live} repo={project.github || undefined} />
    {project.src && <SlideShow images={[project.src]} />}
  </div>
);

const projectDetailsById = new Map(PROJECT_DETAILS.map((project) => [project.id, project]));

const projects: Project[] = portfolioContent.projects
  .filter((project) => project.featured)
  .map((project) => {
    const detail = projectDetailsById.get(project.id);

    return {
      ...(detail ?? {
        id: project.id,
        screenshots: [],
        content: genericProjectContent(project),
      }),
      id: project.id,
      ...
      skills: {
        frontend: getProjectSkills(project.frontendSkills),
        backend: getProjectSkills(project.backendSkills),
      },
    };
  });
